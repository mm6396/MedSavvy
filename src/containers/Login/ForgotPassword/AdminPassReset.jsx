...
const AdminPassReset = () => {
    ...
    const onFinish = async (values) => {
        try {
            setLoading(true);
            await AuthAPI.post('/admin/reset-password', { password: values.password, id: localStorage.getItem('id') });
    ...
    return (
        <Layout className="login-layout" style={{ height: '100vh' }}>
            <Header className="login-header">
                ...
                <div className="systemlogin-text">Password Reset</div>
            </Header>
            ...
            <Content>
                ...
                <Form
                    ...
                    onFinish={onFinish}
                >
                    <div className="systemlogin-mbl">Password Reset</div>
                    <Form.Item
                        name="password"
                        label="New Password"
